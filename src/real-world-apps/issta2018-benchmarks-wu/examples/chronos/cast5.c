...
void cast5_encrypt(struct cast5_ctx *c, uint8_t *outbuf, const uint8_t *inbuf, int rr)
{
	...
	uint32_t *Km;
	uint32_t *Kr;
	uint32_t km_0, km_1, km_2, km_3, km_4, km_5, km_6, km_7;
	uint32_t kr_0, kr_1, kr_2, kr_3, kr_4, kr_5, kr_6, kr_7;
	...
	km_0 = Km[0]; km_1 = Km[1]; km_2 = Km[2]; km_3 = Km[3];
	km_4 = Km[4]; km_5 = Km[5]; km_6 = Km[6]; km_7 = Km[7];
	kr_0 = Kr[0]; kr_1 = Kr[1]; kr_2 = Kr[2]; kr_3 = Kr[3];
	kr_4 = Kr[4]; kr_5 = Kr[5]; kr_6 = Kr[6]; kr_7 = Kr[7];

	t = l; l = r; r = t ^ F1(r, km_0, kr_0);
	t = l; l = r; r = t ^ F2(r, km_1, kr_1);
	t = l; l = r; r = t ^ F3(r, km_2, kr_2);
	t = l; l = r; r = t ^ F1(r, km_3, kr_3);
	t = l; l = r; r = t ^ F2(r, km_4, kr_4);
	t = l; l = r; r = t ^ F3(r, km_5, kr_5);
	t = l; l = r; r = t ^ F1(r, km_6, kr_6);
	t = l; l = r; r = t ^ F2(r, km_7, kr_7);
	
	km_0 = Km[8]; km_1 = Km[9]; km_2 = Km[10]; km_3 = Km[11];
	km_4 = Km[12]; km_5 = Km[13]; km_6 = Km[14]; km_7 = Km[15];
	kr_0 = Kr[8]; kr_1 = Kr[9]; kr_2 = Kr[10]; kr_3 = Kr[11];
	kr_4 = Kr[12]; kr_5 = Kr[13]; kr_6 = Kr[14]; kr_7 = Kr[15];
	t = l; l = r; r = t ^ F3(r, km_0, kr_0);
	t = l; l = r; r = t ^ F1(r, km_1, kr_1);
	t = l; l = r; r = t ^ F2(r, km_2, kr_2);
	t = l; l = r; r = t ^ F3(r, km_3, kr_3);
	//if (!rr) {
		t = l; l = r; r = t ^ F1(r, km_4, kr_4);
		t = l; l = r; r = t ^ F2(r, km_5, kr_5);
		t = l; l = r; r = t ^ F3(r, km_6, kr_6);
		t = l; l = r; r = t ^ F1(r, km_7, kr_7);
	//}
...
void cast5_decrypt(struct cast5_ctx *c, uint8_t *outbuf, const uint8_t *inbuf, int rr)
{
	const uint32_t *src = (const uint32_t *)inbuf;
	uint32_t *dst = (uint32_t *)outbuf;
	uint32_t l, r, t;
...
inline __attribute__((always_inline)) void key_schedule(uint32_t *x, uint32_t *z, uint32_t *k) 
{
...
int main(int argc, char *argv[])
{
	...
	for (int i = 0; i < TEST_DATA_SIZE; i += 64)
		cast5_encrypt(&ctx, out + i, in + i, ctx.rr);
#ifdef gem5
